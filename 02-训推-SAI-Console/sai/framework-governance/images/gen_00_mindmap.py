...
FS=21; ROW=48; TOP=50; GAP=60; PADW=11
...
L.append('<text x="%.1f" y="%.1f" text-anchor="middle" fill="#ffffff" font-size="24" font-weight="700">%s</text>'%(40+root_w/2,root_cy+8,root["t"]))
for n in allnodes:
