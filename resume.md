...
- 故障预防
	...
	- 负责小红书变更风控项目 riskfree 的持续迭代，提供变更灰度阶段的**风险检测**和故障预防能力
...
- 开发和维护 reddog-engine 报警引擎模块，通过定时 poll 方式执行报警规则的实时检测，生成报警事件。
...
- 开发 reddog-proxy 模块，提供产品层后端服务接口，提供**报警规则的配置**提交和 Metric 即时查询能力
	- 配置可视化，提供配置预览和模拟报警的能力
	- 面向通用场景提供抽象的**报警模版**，简化报警配置，减少研发同学和编写 PromQL 的心智负担，提高易用性和告警覆盖率，实现一键配置中间件核心报警
